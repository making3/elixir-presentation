				...
				_0: _xarvh$elm_slides$Slides$mdFragments(
					{
						...
						_1: {
							ctor: '::',
							_0: '* Dynamic, functional language for building scalable and maintainable applications',
							_1: {
								ctor: '::',
								_0: '* Runs on the Erlang virtual machine (BEAM)',
								_1: {
									ctor: '::',
									_0: '* Anything written in Erlang can be ran in Elixir',
									_1: {ctor: '[]'}
								}
							}
						}
						...
						_0: _xarvh$elm_slides$Slides$mdFragments(
							{
								...
								_1: {
									ctor: '::',
									_0: '* Designed for high uptime',
									_1: {
										ctor: '::',
										_0: '* Erlang first appeared in 1986',
										_1: {
											ctor: '::',
											_0: '* If Java is \'write once, run anywhere\', then Erlang is \'write once, run forever\'. - [Joe Armstring](https://www.youtube.com/watch?v=u41GEwIq2mE&t=3m59s)',
											_1: {ctor: '[]'}
										}
									}
								}
																						...
																						_0: _xarvh$elm_slides$Slides$mdFragments(
																							{
																								...
																								_1: {
																									ctor: '::',
																									_0: '* [David Schmitz - Bootstrap |> Elixir](https://www.slideshare.net/koenighotze/bootstrap-elixir-easy-fun-for-busy-developers)',
																									_1: {
																										ctor: '::',
																										_0: '* [Bryan Hunter - What every Node.JS developer needs to know about Elixir](https://vimeo.com/171068992)',
																										_1: {ctor: '[]'}
																									}
																								}
																							}),
